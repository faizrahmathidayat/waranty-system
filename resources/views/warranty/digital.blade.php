...
<head>
    ...
    <style>
        :root { --blue:#0f4c81; --navy:#071b2d; --line:rgba(255,255,255,.16); --active:#18b45b; --expired:#e53935; --void:#6c757d; --claim:#f0a11a; }
        * { box-sizing:border-box; }
        body { margin:0; min-height:100vh; padding:40px 24px; color:#fff; font-family:Poppins,sans-serif; background:radial-gradient(circle at top left,#2b7fff 0,transparent 35%),radial-gradient(circle at bottom right,#0b2a4a 0,transparent 40%),linear-gradient(135deg,var(--navy),var(--blue)); }
